...
@DrawableRes
private fun getBackgroundFromId(id: Long): Int {
    return when (id) {
        0L -> R.drawable.bg_morning
        1L -> R.drawable.bg_day
        2L -> R.drawable.bg_evening
        else -> R.drawable.bg_night
    }
}

private fun getIdFromBackground(@DrawableRes id: Int): Long {
    return when (id) {
